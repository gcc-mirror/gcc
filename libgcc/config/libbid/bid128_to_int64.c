...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_rnint, x)
  ...
  if ((C1.w[1] > 0x0001ed09bead87c0ull)
	...
	if (q <= 19) { // 1 <= q <= 19 => 1 <= 20-q <= 19 => 
	  ...
	  __mul_64x64_to_128MACH (C1, C1.w[0], __bid_ten2k64[20 - q]);
	} else if (q == 20) {
	  ; // C1 * 10^0 = C1
	} else { // if 21 <= q <= 34
	  __mul_128x64_to_128 (C, __bid_ten2k64[q - 20], C); // max 47-bit x 67-bit
	}
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_xrnint, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_floor, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_xfloor, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_ceil, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_xceil, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_int, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_xint, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_rninta, x)
...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(SINT64, __bid128_to_int64_xrninta, x)
