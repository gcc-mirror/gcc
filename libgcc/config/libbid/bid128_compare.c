...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_greater, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_greater_equal, x, y)
  ...
  if (diff > 0) {        // to simplify the loop below,
    ...
    //else { //128 by 64 bit multiply -> 192 bits
    __mul_64x128_to192 (sig_n_prime192, __bid_ten2k64[diff], sig_x);
  ...
  //else { //128 by 64 bit multiply -> 192 bits
  // adjust the y significand upwards
  __mul_64x128_to192 (sig_n_prime192, __bid_ten2k64[diff], sig_y);
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_greater_unordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_less, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_less_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_less_unordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_not_equal, x, y)
  ...
  //else{
  // recalculate y's significand upwards
  __mul_64x128_to192 (sig_n_prime192, __bid_ten2k64[exp_y - exp_x], sig_y);
  {
    res = ((sig_n_prime192.w[2] != 0)
           || (sig_n_prime192.w[1] != sig_x.w[1])
           || (sig_n_prime192.w[0] != sig_x.w[0]));
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_not_greater, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_not_less, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_ordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_quiet_unordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_greater, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_greater_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_greater_unordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_less, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_less_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_less_unordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_not_equal, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_not_greater, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_not_less, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_ordered, x, y)
...
BID128_FUNCTION_ARG2_NORND_CUSTOMRESTYPE(int, __bid128_signaling_unordered, x, y)
