...
void
__bid64_to_int64_rnint (SINT64 * pres, UINT64 * px
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_rnint (UINT64 x
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
#endif
  SINT64 res;
  ...
  if ((q + exp) > 19) { // x >= 10^19 ~= 2^63.11... (cannot fit in SINT64)
    ...
    *pfpsf |= INVALID_EXCEPTION;
    ...
    if (x_sign) { // if n < 0 and q + exp = 19
      ...
      __mul_64x64_to_128MACH (C, C1, __bid_ten2k64[20 - q]);
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_xrnint (SINT64 * pres, UINT64 * px
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_xrnint (UINT64 x
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_floor (SINT64 * pres, UINT64 * px
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_floor (UINT64 x
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_xfloor (SINT64 * pres, UINT64 * px
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_xfloor (UINT64 x
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_ceil (SINT64 * pres, UINT64 * px
		     _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) 
{
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_ceil (UINT64 x
		     _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) 
{
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_xceil (SINT64 * pres, UINT64 * px
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_xceil (UINT64 x
		      _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		      _EXC_INFO_PARAM) {
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_int (SINT64 * pres, UINT64 * px
		    _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_int (UINT64 x
		    _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) {
#endif
  SINT64 res;
  UINT64 x_sign;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_xint (SINT64 * pres, UINT64 * px
		     _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) 
{
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_xint (UINT64 x
		     _EXC_FLAGS_PARAM _EXC_MASKS_PARAM _EXC_INFO_PARAM) 
{
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_rninta (SINT64 * pres, UINT64 * px
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_rninta (UINT64 x
		       _EXC_FLAGS_PARAM _EXC_MASKS_PARAM
		       _EXC_INFO_PARAM) {
#endif
  SINT64 res;
...
#if DECIMAL_CALL_BY_REFERENCE
void
__bid64_to_int64_xrninta (SINT64 * pres, UINT64 * px
			_EXC_FLAGS_PARAM _EXC_MASKS_PARAM
			_EXC_INFO_PARAM) {
  UINT64 x = *px;
#else
SINT64
__bid64_to_int64_xrninta (UINT64 x
			_EXC_FLAGS_PARAM _EXC_MASKS_PARAM
			_EXC_INFO_PARAM) {
#endif
  SINT64 res;
