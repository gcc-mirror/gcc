...
BID128_FUNCTION_ARG1_NORND_CUSTOMRESTYPE(int, __bid128_to_int32_rnint, x)
  ...
  if ((C1.w[1] > 0x0001ed09bead87c0ull)
	...
	if (q <= 11) {
	  ...
	  if (q - 11 <= 19) { // 1 <= q - 11 <= 19; 10^(q-11) requires 64 bits
	    __mul_64x64_to_128MACH (C, tmp64, __bid_ten2k64[q - 11]);
	  } else { // 20 <= q - 11 <= 23, and 10^(q-11) requires 128 bits
	    __mul_128x64_to_128 (C, tmp64, __bid_ten2k128[q - 31]);
	  }
