...
extern struct mrules *deps_init (void);

/* Destroy a deps buffer.  */
extern void deps_free (struct mrules *);
...
extern void deps_add_vpath (struct mrules *, const char *);

/* Add a target (appears on left side of the colon) to the deps list.  Takes
   a boolean indicating whether to quote the target for MAKE.  */
extern void deps_add_target (struct mrules *, const char *, int);
...
extern void deps_add_dep (struct mrules *, const char *);
...
extern int deps_save (struct mrules *, FILE *);
