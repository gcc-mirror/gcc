...
int f0_1_tg (void) { assert (false); return 42; }
...
void f0_1_tgsy (void) { assert (false); }
...
int f0_1_tgtgsy (void) { assert (false); return 33; }
...
void f0_1_tgsy_c_cd_hi_hs (void) { assert (false); }
...
void f0_1_tgsy_hs_cd_c_hi (void) { assert (false); }
...
void f0_1_tgsy_hs_hi_cd_c (void) { assert (false); }
