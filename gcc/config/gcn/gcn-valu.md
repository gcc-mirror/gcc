...
(define_insn "gather<mode>_insn_1offset<exec>"
  [(set (match_operand:V_MOV 0 "register_operand"		   "=v,&v,a")
	(unspec:V_MOV
	  [(plus:<VnDI> (match_operand:<VnDI> 1 "register_operand" " v, v,v")
			(vec_duplicate:<VnDI>
			  (match_operand 2 "immediate_operand"	   " n, n,n")))
	   (match_operand 3 "immediate_operand"			   " n, n,n")
	   (match_operand 4 "immediate_operand"			   " n, n,n")
	   (mem:BLK (scratch))]
	  UNSPEC_GATHER))]
  ...
  [(set (match_operand:V_MOV 0 "register_operand"		     "=v,&v,a")
	(unspec:V_MOV
	  [(plus:<VnDI>
	     (plus:<VnDI>
	       (vec_duplicate:<VnDI>
		 (match_operand:DI 1 "register_operand"		     "Sv,Sv,Sv"))
	       (sign_extend:<VnDI>
		 (match_operand:<VnSI> 2 "register_operand"	     " v, v,v")))
	     (vec_duplicate:<VnDI> (match_operand 3 "immediate_operand"
								     " n, n,n")))
	   (match_operand 4 "immediate_operand"			     " n, n,n")
	   (match_operand 5 "immediate_operand"			     " n, n,n")
	   (mem:BLK (scratch))]
	  UNSPEC_GATHER))]
