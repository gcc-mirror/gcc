...
;; Whether an insn loads an external address for the PCREL_OPT optimization.
...
;; Optimize converting SF/DFmode to signed SImode and back to SF/DFmode.  This
...
;; fprs.  There isn't a dependency between the two, but we could potentially
...
;; Operand0 is the address of the function to call
