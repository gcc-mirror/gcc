...
module m
 ...
 !$omp declare target enter(x) device_type ( any )  ! { dg-error "List item 'x' at .1. should not appear in the 'enter' clause, as it was previously specified in a GROUPPRIVATE directive" }
 !$omp declare target to(z) device_type ( any )  ! { dg-error "List item 'z' at .1. should not appear in the 'to' clause, as it was previously specified in a GROUPPRIVATE directive" }
 !$omp declare target link(o) device_type ( any )  ! { dg-error "List item 'o' at .1. should not appear in the 'link' clause, as it was previously specified in a GROUPPRIVATE directive" }
...
subroutine sub()
  ...
  !$omp declare target(x0)  ! { dg-error "List item 'x0' at .1. should not appear in the 'enter' clause, as it was previously specified in a GROUPPRIVATE directive" }
  !$omp declare target device_type(any) to(x1)  ! { dg-error "List item 'x1' at .1. should not appear in the 'to' clause, as it was previously specified in a GROUPPRIVATE directive" }
  !$omp declare target device_type(any) enter(x2)  ! { dg-error "List item 'x2' at .1. should not appear in the 'enter' clause, as it was previously specified in a GROUPPRIVATE directive" }
  !$omp declare target device_type(host) link(x3)  ! { dg-error "List item 'x3' at .1. should not appear in the 'link' clause, as it was previously specified in a GROUPPRIVATE directive" }
