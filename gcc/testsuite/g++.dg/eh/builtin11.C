...
extern "C" void *__cxa_begin_catch (int);			// { dg-message "previous declaration" }
extern "C" void __cxa_end_catch (long long);			// { dg-message "previous declaration" }
extern "C" void __cxa_rethrow (int);				// { dg-message "previous declaration" }
extern "C" void *__cxa_allocate_exception (void *);		// { dg-message "previous declaration" }
