...
// { dg-final { scan-lang-dump-times {Read:-1's named merge key \(new\) function_decl:'::C@A:.::__dt '\n} 1 module } }
// { dg-final { scan-lang-dump-times {Adding implicit member '::C@A:.::__dt @B:.} 1 module } }
// { dg-final { scan-lang-dump-times {Read:-1's named merge key \(new\) function_decl:'::C@A:.::__ct '\n} 3 module } }
// { dg-final { scan-lang-dump-times {Adding implicit member '::C@A:.::__ct @B:.} 3 module } }
// { dg-final { scan-lang-dump-times {Read:-1's named merge key \(new\) function_decl:'::C@A:.::operator='\n} 2 module } }
