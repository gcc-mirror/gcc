...
// { dg-final { scan-lang-dump {Writing named key for mergeable decl type_decl:'::__builtin_va_list'} module } }

// { dg-final { scan-lang-dump { Cluster members:\n  \[0\]=decl declaration '::va_list'\n  \[1\]=binding '::va_list'\n} module } }
// { dg-final { scan-lang-dump {Wrote GMF:-[0-9]* type_decl:'::va_list'@builtins} module } }
// { dg-final { scan-lang-dump {Writing named key for mergeable decl type_decl:'::va_list'} module } }
