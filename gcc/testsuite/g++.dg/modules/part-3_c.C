...
// { dg-final { scan-lang-dump {Read:-[0-9] matched mergeable decl function_decl:'::foo@2\(:bar\)'} module } }
// { dg-final { scan-lang-dump {Recording new skippable function_decl:'::foo@2\(:bar\)'} module } }
