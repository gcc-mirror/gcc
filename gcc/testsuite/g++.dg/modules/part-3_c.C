...
// { dg-final { scan-lang-dump {Read:-[0-9] new mergeable decl function_decl:'::foo@foo:bar:2'} module } }
// { dg-final { scan-lang-dump {Read:-[0-9] matched mergeable decl function_decl:'::foo@foo:baz:3'} module } }
