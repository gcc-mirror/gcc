...
// { dg-final { scan-lang-dump {Wrote instantiation:-[0-9]* function_decl:'::foo::X@2\(foo\)::frob<0x0>'@} module } }
...
// { dg-final { scan-lang-dump {Wrote import:-[0-9]* function_decl:'::foo::TPL@2\(foo\)<0x0>::frob<0x0>'@foo} module } }
