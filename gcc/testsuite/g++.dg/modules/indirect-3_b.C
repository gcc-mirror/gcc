...
// { dg-final { scan-lang-dump {Writing specialization key for mergeable specialization type_decl:'::foo::TPL@bar:1<0x0>'} module } }
// { dg-final { scan-lang-dump {Writing specialization key for mergeable specialization function_decl:'::foo::X@foo:2::frob@bar:1<0x0>'} module } }
