...
// { dg-final { scan-lang-dump {Wrote instantiation:-[0-9]* function_decl:'::foo::X::frob'@} module } }
...
// { dg-final { scan-lang-dump {Wrote import:-[0-9]* function_decl:'::foo::TPL::frob'@foo} module } }
