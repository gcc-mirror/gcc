...
// { dg-final { scan-lang-dump {Writing decl spec key for mergeable specialization function_decl:'::foo::frob<0x0>'} module } }
...
// { dg-final { scan-lang-dump {Cluster members:\n  \[0\]=specialization definition '::foo::X<0x0>'\n  \[1\]=specialization declaration '::foo::X<0x0>::X<0x0>'\n  \[2\]=specialization declaration '::foo::X<0x0>::__conv_op <0x0>'\n} module } }
// { dg-final { scan-lang-dump {Writing type spec key for mergeable specialization type_decl:'::foo::X<0x0>'} module } }
// { dg-final { scan-lang-dump {Depset:0 specialization entity:. type_decl:'::foo::X<0x0>'} module } }
// { dg-final { scan-lang-dump {Writing type spec key for mergeable specialization type_decl:'::foo::X<0x0>'} module } }
