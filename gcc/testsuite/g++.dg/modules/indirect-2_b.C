...
// { dg-final { scan-lang-dump {Writing decl specialization key for mergeable specialization function_decl:'::foo::frob@bar:1<0x0>'} module } }
...
// { dg-final { scan-lang-dump {Writing type specialization key for mergeable specialization type_decl:'::foo::X@bar:1<0x0>'} module } }
