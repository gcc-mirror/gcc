...
// { dg-final { scan-lang-dump {Wrote mergeable:-4 function_decl:'::foo@foo:1<int>'\(_Z3fooIiEiT_\)} module } }
...
// { dg-final { scan-lang-dump {Wrote:-4 global specialization function_decl:'::foo@foo:1<int>'} module } }
