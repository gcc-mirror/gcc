...
/* { dg-final { scan-tree-dump "58:12: optimized: basic block part vectorized" "slp1" { target x86_64-*-* } } } */
/* { dg-final { scan-tree-dump-not "Cannot determine insertion place" "slp1" } } */
