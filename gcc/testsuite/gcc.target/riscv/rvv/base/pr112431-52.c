  ...
  for (int i = 0; i < n; i++)
    {
      ...
      v0 = __riscv_vwmulsu_vx_i16m4_tu (v0, v0_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v1 = __riscv_vwmulsu_vx_i16m4_tu (v1, v1_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v2 = __riscv_vwmulsu_vx_i16m4_tu (v2, v2_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v3 = __riscv_vwmulsu_vx_i16m4_tu (v3, v3_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v4 = __riscv_vwmulsu_vx_i16m4_tu (v4, v4_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v5 = __riscv_vwmulsu_vx_i16m4_tu (v5, v5_n, x, 4);
      asm volatile("nop" ::: "memory");
      ...
      v6 = __riscv_vwmulsu_vx_i16m4_tu (v6, v6_n, x, 4);
      asm volatile("nop" ::: "memory");
      vint8m2_t v7_n = __riscv_vle8_v_i8m2 (in, 4);in+=100;
      vint16m4_t v7 = __riscv_vwmulsu_vx_i16m4 (v7_n, x, 4);
...
/* The narrowed source is the highest-numbered half of the tail-undisturbed
   destination, thus it overlaps the destination register group.  The trailing
   non-tu operation is expected to overlap as well.  */
/* { dg-final { scan-assembler-times {vwmulsu\.vx\s+v4,v6,} 8 } } */
