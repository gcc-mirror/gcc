...
void
foo (void *in, void *out, int n, int8_t x)
{
  for (int i = 0; i < n; i++)
    {
      ...
      v0 = __riscv_vwmacc_vx_i16m4_tu (v0, x, v0_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v1 = __riscv_vwmacc_vx_i16m4_tu (v1, x, v1_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v2 = __riscv_vwmacc_vx_i16m4_tu (v2, x, v2_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v3 = __riscv_vwmacc_vx_i16m4_tu (v3, x, v3_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v4 = __riscv_vwmacc_vx_i16m4_tu (v4, x, v4_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v5 = __riscv_vwmacc_vx_i16m4_tu (v5, x, v5_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v6 = __riscv_vwmacc_vx_i16m4_tu (v6, x, v6_n, 4);
      asm volatile("nop" ::: "memory");
...
/* The narrowed source is the highest-numbered half of the accumulator, thus it
   overlaps the destination register group.  */
/* { dg-final { scan-assembler-times {vwmacc\.vx\s+v4,[^,]+,v6([^0-9]|$)} 7 } } */
