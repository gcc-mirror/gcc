...
vbool64_t test___riscv_vmsgeu_vv_u8mf8_b64(vbool64_t mask,vuint8mf8_t op1,vuint8mf8_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8mf8_b64(op1,op2,vl);
}


vbool32_t test___riscv_vmsgeu_vv_u8mf4_b32(vbool32_t mask,vuint8mf4_t op1,vuint8mf4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8mf4_b32(op1,op2,vl);
}


vbool16_t test___riscv_vmsgeu_vv_u8mf2_b16(vbool16_t mask,vuint8mf2_t op1,vuint8mf2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8mf2_b16(op1,op2,vl);
}


vbool8_t test___riscv_vmsgeu_vv_u8m1_b8(vbool8_t mask,vuint8m1_t op1,vuint8m1_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8m1_b8(op1,op2,vl);
}


vbool4_t test___riscv_vmsgeu_vv_u8m2_b4(vbool4_t mask,vuint8m2_t op1,vuint8m2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8m2_b4(op1,op2,vl);
}


vbool2_t test___riscv_vmsgeu_vv_u8m4_b2(vbool2_t mask,vuint8m4_t op1,vuint8m4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8m4_b2(op1,op2,vl);
}


vbool1_t test___riscv_vmsgeu_vv_u8m8_b1(vbool1_t mask,vuint8m8_t op1,vuint8m8_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u8m8_b1(op1,op2,vl);
}


vbool64_t test___riscv_vmsgeu_vv_u16mf4_b64(vbool64_t mask,vuint16mf4_t op1,vuint16mf4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16mf4_b64(op1,op2,vl);
}


vbool32_t test___riscv_vmsgeu_vv_u16mf2_b32(vbool32_t mask,vuint16mf2_t op1,vuint16mf2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16mf2_b32(op1,op2,vl);
}


vbool16_t test___riscv_vmsgeu_vv_u16m1_b16(vbool16_t mask,vuint16m1_t op1,vuint16m1_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16m1_b16(op1,op2,vl);
}


vbool8_t test___riscv_vmsgeu_vv_u16m2_b8(vbool8_t mask,vuint16m2_t op1,vuint16m2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16m2_b8(op1,op2,vl);
}


vbool4_t test___riscv_vmsgeu_vv_u16m4_b4(vbool4_t mask,vuint16m4_t op1,vuint16m4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16m4_b4(op1,op2,vl);
}


vbool2_t test___riscv_vmsgeu_vv_u16m8_b2(vbool2_t mask,vuint16m8_t op1,vuint16m8_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u16m8_b2(op1,op2,vl);
}


vbool64_t test___riscv_vmsgeu_vv_u32mf2_b64(vbool64_t mask,vuint32mf2_t op1,vuint32mf2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u32mf2_b64(op1,op2,vl);
}


vbool32_t test___riscv_vmsgeu_vv_u32m1_b32(vbool32_t mask,vuint32m1_t op1,vuint32m1_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u32m1_b32(op1,op2,vl);
}


vbool16_t test___riscv_vmsgeu_vv_u32m2_b16(vbool16_t mask,vuint32m2_t op1,vuint32m2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u32m2_b16(op1,op2,vl);
}


vbool8_t test___riscv_vmsgeu_vv_u32m4_b8(vbool8_t mask,vuint32m4_t op1,vuint32m4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u32m4_b8(op1,op2,vl);
}


vbool4_t test___riscv_vmsgeu_vv_u32m8_b4(vbool4_t mask,vuint32m8_t op1,vuint32m8_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u32m8_b4(op1,op2,vl);
}


vbool64_t test___riscv_vmsgeu_vv_u64m1_b64(vbool64_t mask,vuint64m1_t op1,vuint64m1_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u64m1_b64(op1,op2,vl);
}


vbool32_t test___riscv_vmsgeu_vv_u64m2_b32(vbool32_t mask,vuint64m2_t op1,vuint64m2_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u64m2_b32(op1,op2,vl);
}


vbool16_t test___riscv_vmsgeu_vv_u64m4_b16(vbool16_t mask,vuint64m4_t op1,vuint64m4_t op2,size_t vl)
{
    return __riscv_vmsgeu_vv_u64m4_b16(op1,op2,vl);
}


vbool8_t test___riscv_vmsgeu_vv_u64m8_b8(vbool8_t mask,vuint64m8_t op1,vuint64m8_t op2,size_t vl)
{
