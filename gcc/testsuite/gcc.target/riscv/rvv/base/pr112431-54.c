  ...
  for (int i = 0; i < n; i++)
    {
      ...
      v0 = __riscv_vwmaccu_vx_u16m4_tu (v0, x, v0_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v1 = __riscv_vwmaccu_vx_u16m4_tu (v1, x, v1_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v2 = __riscv_vwmaccu_vx_u16m4_tu (v2, x, v2_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v3 = __riscv_vwmaccu_vx_u16m4_tu (v3, x, v3_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v4 = __riscv_vwmaccu_vx_u16m4_tu (v4, x, v4_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v5 = __riscv_vwmaccu_vx_u16m4_tu (v5, x, v5_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v6 = __riscv_vwmaccu_vx_u16m4_tu (v6, x, v6_n, 4);
      asm volatile("nop" ::: "memory");
