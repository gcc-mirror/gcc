  ...
  for (int i = 0; i < n; i++)
    {
      ...
      vint16m2_t v0_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v0, 1));
      v0 = __riscv_vwmaccus_vx_i32m4_tu (v0, x, v0_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v1 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v1_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v1, 1));
      v1 = __riscv_vwmaccus_vx_i32m4_tu (v1, x, v1_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v2 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v2_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v2, 1));
      v2 = __riscv_vwmaccus_vx_i32m4_tu (v2, x, v2_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v3 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v3_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v3, 1));
      v3 = __riscv_vwmaccus_vx_i32m4_tu (v3, x, v3_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v4 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v4_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v4, 1));
      v4 = __riscv_vwmaccus_vx_i32m4_tu (v4, x, v4_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v5 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v5_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v5, 1));
      v5 = __riscv_vwmaccus_vx_i32m4_tu (v5, x, v5_n, 4);
      asm volatile("nop" ::: "memory");
      vint32m4_t v6 = __riscv_vle32_v_i32m4 (in, 4);in+=100;
      vint16m2_t v6_n = __riscv_vreinterpret_v_i32m2_i16m2 (__riscv_vget_v_i32m4_i32m2 (v6, 1));
