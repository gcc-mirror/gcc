  ...
  for (int i = 0; i < n; i++)
    {
      ...
      v0 = __riscv_vwmacc_vv_i16m4_tu (v0, v0_n, v0_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v1 = __riscv_vwmacc_vv_i16m4_tu (v1, v1_n, v1_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v2 = __riscv_vwmacc_vv_i16m4_tu (v2, v2_n, v2_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v3 = __riscv_vwmacc_vv_i16m4_tu (v3, v3_n, v3_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v4 = __riscv_vwmacc_vv_i16m4_tu (v4, v4_n, v4_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v5 = __riscv_vwmacc_vv_i16m4_tu (v5, v5_n, v5_n, 4);
      asm volatile("nop" ::: "memory");
      ...
      v6 = __riscv_vwmacc_vv_i16m4_tu (v6, v6_n, v6_n, 4);
      asm volatile("nop" ::: "memory");
