  ...
  for (int i = 0; i < n; i++)
    {
      ...
      v0 = __riscv_vwmulsu_vv_i16m4_tu (v0, v0_n, v0_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v1 = __riscv_vwmulsu_vv_i16m4_tu (v1, v1_n, v1_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v2 = __riscv_vwmulsu_vv_i16m4_tu (v2, v2_n, v2_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v3 = __riscv_vwmulsu_vv_i16m4_tu (v3, v3_n, v3_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v4 = __riscv_vwmulsu_vv_i16m4_tu (v4, v4_n, v4_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v5 = __riscv_vwmulsu_vv_i16m4_tu (v5, v5_n, v5_nu, 4);
      asm volatile("nop" ::: "memory");
      ...
      v6 = __riscv_vwmulsu_vv_i16m4_tu (v6, v6_n, v6_nu, 4);
      asm volatile("nop" ::: "memory");
