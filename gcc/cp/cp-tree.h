...
/* If set, this or a subsequent overload was via a using declaration.   */
#define OVL_HAS_USING_P(NODE) TREE_LANG_FLAG_5 (OVERLOAD_CHECK (NODE))
...
extern void atom_module_preamble (location_t, line_maps *, unsigned);
