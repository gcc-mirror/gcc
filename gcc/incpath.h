...
enum incpath_e { INC_QUOTE = 0, /* include "foo" */
...
extern void add_path (char *, incpath_e, int, bool);
extern void register_include_chains (cpp_reader *, const char *,
				     const char *, const char *,
				     int, int, int);
extern void add_cpp_dir_path (struct cpp_dir *, incpath_e);
extern struct cpp_dir *get_added_cpp_dirs (incpath_e);
