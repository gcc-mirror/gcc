...
#define GCOV_TAG_SUPPRESS	      ((gcov_unsigned_t)0x01510000)
#define GCOV_TAG_SUPPRESS_LENGTH(NUM) ((NUM) * GCOV_WORD_SIZE)
#define GCOV_TAG_SUPPRESS_NUM(LENGTH) ((LENGTH / GCOV_WORD_SIZE))
